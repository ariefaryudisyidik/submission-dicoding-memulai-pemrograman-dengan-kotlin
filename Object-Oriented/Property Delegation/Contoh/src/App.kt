...
/*
   output:
       ...
       Fungsi ini sama seperti getter untuk properti name pada class Animal@2e0fa5d3
       Nama Hewan: Dicoding Miaw
       Nilai name dari: Default akan berubah menjadi Dimas
       Fungsi ini sama seperti getter untuk properti name pada class Person@5010be6
       Nama Orang: Dimas
       Nilai name dari: Default akan berubah menjadi Gatotkaca
       Fungsi ini sama seperti getter untuk properti name pada class Hero@685f4c2e
